package info.project.orion.fragment.workshops;
...
public class WorkshopsFragment extends Fragment {
    ...
    private static final String TAG = WorkshopsFragment.class.getSimpleName();

    private static final String URL = Url.workshopsUrl;

    private RecyclerView recyclerView;
    private List<Events> itemsList;
    private WorkshopsFragment.StoreAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new WorkshopsFragment.StoreAdapter(getActivity(), itemsList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new WorkshopsFragment.GridSpacingItemDecoration(2, dpToPx(8), true));
     ...
     */
    class StoreAdapter extends RecyclerView.Adapter<WorkshopsFragment.StoreAdapter.MyViewHolder> {
        ...
        @Override
        public WorkshopsFragment.StoreAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.store_item_row, parent, false);

            return new WorkshopsFragment.StoreAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(WorkshopsFragment.StoreAdapter.MyViewHolder holder, final int position) {
