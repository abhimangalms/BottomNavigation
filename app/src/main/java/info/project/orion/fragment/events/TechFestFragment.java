...
public class TechFestFragment extends Fragment {

    private static final String TAG = TechFestFragment.class.getSimpleName();

    private static final String URL = Url.techFestUrl;;

    private RecyclerView recyclerView;
    private List<Events> itemsList;
    private StoreAdapter mAdapter;

    public TechFestFragment() {
        // Required empty public constructor
    }

    public static TechFestFragment newInstance(String param1, String param2) {
        TechFestFragment fragment = new TechFestFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tech_fest, container, false);
