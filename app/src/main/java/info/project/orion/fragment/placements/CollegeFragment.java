...
public class CollegeFragment extends Fragment {
    ...
    private static final String URL = Url.collegePlacementUrl;;

    private RecyclerView recyclerView;
    private List<Events> itemsList;
    private CollegeFragment.StoreAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new CollegeFragment.StoreAdapter(getActivity(), itemsList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new CollegeFragment.GridSpacingItemDecoration(2, dpToPx(8), true));
     ...
     */
    class StoreAdapter extends RecyclerView.Adapter<CollegeFragment.StoreAdapter.MyViewHolder> {
        ...
        @Override
        public CollegeFragment.StoreAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.store_item_row, parent, false);

            return new CollegeFragment.StoreAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(CollegeFragment.StoreAdapter.MyViewHolder holder, final int position) {
